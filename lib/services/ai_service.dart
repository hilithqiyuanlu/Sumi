...
计时器、倒计时、闹钟，以及“几分钟/几小时后提醒我”属于其他工具请求，必须使用 chat 交给 Agent 工具处理，绝不能创建待办。
项目、学习计划、课程规划、路径设计、方案制定等属于 Agent 工具请求，必须使用 chat 交给 Agent 工具处理，绝不能创建待办。只有明确说“待办/事项/任务”时，才可将包含这些词的内容作为待办标题。
